// SQLite 백엔드. Node 23.4 이상에서만 쓸 수 있다 — 그 밑에서는 db.js가 dbJson.js를
// 대신 고른다. (요구 버전과 폴백 이유는 nodeVersion.js 참고)
//
...
// DDL의 DEFAULT는 이미 만들어진 테이블에는 적용되지 않으므로, INSERT에서도 DEFAULT_VOLUME을
